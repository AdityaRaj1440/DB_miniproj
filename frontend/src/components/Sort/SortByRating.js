...
const SortByRating = ( {auth} ) => {
    ...
    const onSubmitChange = (e) => {
        e.preventDefault()
        axios.get(`http://localhost:3000/sort/adaptations/rating/${order}`)
        .then(res=>{
            ...
            <div>
                <div className="w3-container boundary content" style={{marginLeft:'14rem'}}>
                    <div style = {{ display: 'flex' ,justifyContent: 'space-between' }}>
                        <h2 className='head'>SORTING BY RATING</h2>
                    </div><hr />
                    <p><b> GET /sort/rating </b><br />Get the sorted information about comics , novels.</p>
