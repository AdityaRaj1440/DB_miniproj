...
const FilterLive = () => {
    ...
    const onSubmitChange = (e) => {
        e.preventDefault()
        axios.get(`http://localhost:3000/showGenre/filterLive/${name}`)
        .then(res=>{
                    ...
                    <div style={{marginLeft: '10px'}} >
                        {
                            ...
                            <a href={`http://localhost:3000/showGenre/filterLive/${name}`} className='b i pa1'>http://localhost:3000/showGenre/filterLive/${name}</a>
                                </div>
                            : <></>
                        }
                    </div>
