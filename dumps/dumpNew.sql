...
CREATE TABLE `anime` (
  ...
  PRIMARY KEY (`Type`,`Adapt_id`),
  CONSTRAINT `anime_ibfk_1` FOREIGN KEY (`Type`, `Adapt_id`) REFERENCES `adaptations` (`Type`, `Adapt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `live` (
  ...
  `Mode` char(3) DEFAULT NULL,
  PRIMARY KEY (`Type`,`Adapt_id`),
  CONSTRAINT `live_ibfk_1` FOREIGN KEY (`Type`, `Adapt_id`) REFERENCES `adaptations` (`Type`, `Adapt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `music` (
  ...
  CONSTRAINT `music_ibfk_1` FOREIGN KEY (`Artist_id`) REFERENCES `music_artists` (`Artist_id`),
  CONSTRAINT `music_ibfk_2` FOREIGN KEY (`Type`, `Adapt_id`) REFERENCES `adaptations` (`Type`, `Adapt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `music` VALUES ('R01','N04','Todoroki Rap- Frostbite','2020-07-11','ANI',6,'Rap','https://www.youtube.com/watch?v=ICLTV_Ijl70'),('R02','N03','Gojo Rap- Running in Blind','2021-07-03','ANI',2,'Rap','https://www.youtube.com/watch?v=AqKm5HFWAZw'),('R03','N04','Eren Jaeger Rap- Titans','2021-03-13','ANI',3,'Rap','https://www.youtube.com/watch?v=nda5Z_8UT_4'),('R04','N09','Uchiha Rap Cypher','2020-04-03','ANI',4,'Rap Cypher','https://www.youtube.com/watch?v=1PCervmcKtg&t=129s'),('R05','N10','Bleach Rap- Soul Reaper Captains','2020-04-04','ANI',5,'Rap Cypher','https://www.youtube.com/watch?v=854sHPNAJYY'),('R06','N03','LUFFY, ZORO & SANJI RAP- Monster Trio','2020-11-07','ANI',7,'Rap','https://www.youtube.com/watch?v=Fqxxs6eBfso'),('R07','N09','Fairy Tail Guild Rap Cypher Remix','2021-06-05','ANI',8,'Rap Cypher','https://www.youtube.com/watch?v=nrphRbGrVLs'),('R08','N04','Gon Rap- Forgive Me','2020-05-30','ANI',14,'Rap','https://www.youtube.com/watch?v=Iz0HjeTMnpA'),('R09','N05','SAITAMA SONG- All it takes','2021-04-16','ANI',16,'Rap Song','https://www.youtube.com/watch?v=BnLQ6TNTDEw'),('R10','N07','Jin Mori Rap- The God of High School','2020-10-03','ANI',27,'Rap','https://www.youtube.com/watch?v=jmtK-gQWR-k');
...
INSERT INTO `novel_genre` VALUES (1,1),(2,1),(7,1),(9,1),(22,1),(1,2),(9,2),(9,3),(25,3),(7,4),(23,4),(31,4),(1,5),(2,5),(4,5),(7,5),(9,5),(11,5),(20,5),(22,5),(23,5),(2,6),(11,6),(16,6),(17,6),(2,7),(11,7),(16,7),(17,7);
...
-- Dump completed on 2022-02-02 23:20:07
