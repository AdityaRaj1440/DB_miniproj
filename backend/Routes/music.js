...
router.get('/', (req, res) => {
    let sql=  `select  Distinct MA.Name Artist_name, A.Name as Source, M.* from Adaptations A inner join Comic_Genre CG on A.Comic_id= CG.Comic_id and A.Origin_id= CG.Origin_id
